...
import { ImageBoardObjectContainerRuntimeFactory, IImageBoardObjectAppModel } from "./container";
import { ImageBoardObjectView } from "./view";
...
async function start() {
	...
	let id: string;
	let model: IImageBoardObjectAppModel;
