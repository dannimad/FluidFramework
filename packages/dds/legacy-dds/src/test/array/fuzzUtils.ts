...
import type { SharedArrayFactory, SerializableTypeForSharedArray } from "../../index.js";

import { assertEquivalentArrays } from "./arrayEquivalenceUtils.js";
...
type MapState = DDSFuzzTestState<SharedArrayFactory<SerializableTypeForSharedArray>>;
 ...
 * the maps fuzz model
 */
export const baseMapModel: DDSFuzzModel<
